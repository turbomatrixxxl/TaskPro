  ...
  return (
    <div
      className={clsx(
        ...
        user?.theme === "dark"
          ? styles.helpContainerDark
          : user?.theme === "violet"
          ? styles.helpContainerViolet
          : styles.helpContainer
      )}>
      ...
      <div
        className={clsx(
          styles.helpText,
          user?.theme !== "light" ? styles.white : styles.helpText
        )}>
        <p>
          ...
          <span
            className={clsx(
              styles.highlight,
              user?.theme === "violet" ? styles.violet : styles.highlight
            )}>
            TaskPro
          </span>
      ...
      <div
        className={clsx(
          styles.helpBar,
          user?.theme !== "light" ? styles.white : styles.helpBar
        )}
        ...
        <svg
          ...
          <g clipPath="url(#clip0_276_1776)">
            <path
              ...
              stroke={user?.theme !== "light" ? "white" : "#161616"}
              strokeWidth="1.8"
              strokeLinecap="round"
